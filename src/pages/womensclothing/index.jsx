...
const WomensClothing = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const [dressesRes, shoesRes, bagsRes, watchesRes] = await Promise.all([
        ...
        setDresses(dressesRes.data.products);
        setShoes(shoesRes.data.products);
        setBags(bagsRes.data.products);
          ...
          return (
            ...
            >
              ...
              <div className="pt-5 text-lg text-center">
                ...
                <div className="mt-2 bg-green-100 font-satoshi text-green-800 text-xs font-bold px-2 py-1 rounded">
